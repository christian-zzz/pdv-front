...
const Header = () => {
    return (
        <header className="sticky top-0 left-0 right-0 z-50 grid grid-cols-[1fr_auto_1fr] items-center py-4 px-12 backdrop-blur-lg border-b border-white/10 shadow-lg text-white">
            {/* Left Links */}
